...
#define qdma_waitq_wakeup               swake_up_one
#define qdma_waitq_wait_event           swait_event_interruptible_exclusive
#define qdma_waitq_wait_event_timeout   swait_event_interruptible_timeout_exclusive
