...
function main()
{
	...
	bin/dma-ctl $2 q add idx 16 mode mm dir bi	# test q
	bin/dma-ctl $2 q start idx 16 dir bi
	# bin/dma-ctl $2 q start idx 8 dir c2h desc_bypass_en pfetch_bypass_en
}
