...
static struct nla_policy xnl_policy[XNL_ATTR_MAX] = {
	...
	[XNL_ATTR_PCI_FUNC] =		{ .type = NLA_U32 },
        ...
        [XNL_ATTR_DEV_STAT_MMH2C_PKTS1] = { .type = NLA_U32 },
        [XNL_ATTR_DEV_STAT_MMH2C_PKTS2] = { .type = NLA_U32 },
        [XNL_ATTR_DEV_STAT_MMC2H_PKTS1] = { .type = NLA_U32 },
        [XNL_ATTR_DEV_STAT_MMC2H_PKTS2] = { .type = NLA_U32 },
        [XNL_ATTR_DEV_STAT_STH2C_PKTS1] = { .type = NLA_U32 },
        [XNL_ATTR_DEV_STAT_STH2C_PKTS2] = { .type = NLA_U32 },
        [XNL_ATTR_DEV_STAT_STC2H_PKTS1] = { .type = NLA_U32 },
        [XNL_ATTR_DEV_STAT_STC2H_PKTS2] = { .type = NLA_U32 },
	...
	[XNL_ATTR_INTR_VECTOR_IDX] =	{ .type = NLA_U32 },
        ...
        [XNL_ATTR_GLOBAL_CSR] =          { .type = NLA_U32 },
...
static int xnl_register_read(struct sk_buff *skb2, struct genl_info *info)
{
	...
	if (bar_num == conf.bar_num_config) {
		...
		rv += sprintf(buf + rv, "Invalid bar number %x\n", bar_num);
		goto send_resp;
	}
