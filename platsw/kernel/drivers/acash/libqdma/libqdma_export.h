...
void qdma_sw_sg_dump(struct qdma_sw_sg*);
 ...
 * @dev_hndl:	dev_hndl returned from qdma_device_open()
 * @id:		    the opaque qhndl
 * @buflen:		length of the input buffer (actually it holds error msg after return)
 * @buf:		message buffer (see above)
 *
 * Return:	0 for success and <0 for error
 *
 *****************************************************************************/
...
/*****************************************************************************/
/**
 * qdma_dump_device_conf() - display the device configure
 *
 * @conf:	device_conf
 *
 * Return: none
...
/*****************************************************************************/
/**
 * qdma_dump_queue_conf() - display the queue configure
 *
 * @conf:	qdma_queue_conf
 *
 * Return: none
 *
 *****************************************************************************/
